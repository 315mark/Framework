...
//        Beta.canAutoPatch =true;
        ...
        Bugly.init(this,"0dbc654039",true);
        long end=System.currentTimeMillis();
        Log.i("init time --->", end - start + "ms");
        ...
        /*Beta.upgradeStateListener =new UpgradeStateListener() {
            ...
            public void onUpgradeSuccess(boolean b) {
                ToastUtil.showShort("是否更新成功"+b);
            }

            @Override
            public void onUpgradeNoVersion(boolean b) {
                ToastUtil.showShort("最新版本");
            }
            ...
            public void onDownloadCompleted(boolean b) {
                ToastUtil.showShort("是否下载完成"+b);
            }
        };*/

        /**
         * 补丁回调接口,可以监听补丁接收、下载、合成回调  热修复
         */
...
//                ToastUtil.showShort(String.format(Locale.getDefault(),"%s %d%%",Beta.strNotificationDownloading,(totalLength  == 0 ? 0 :savedLength *100 / totalLength )));
//            }
//
//            @Override
//            public void onDownloadSuccess(String s) {
//                ToastUtil.showShort("下载成功"+s);
//            }
//
//            @Override
